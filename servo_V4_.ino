//Code References
//This code is based off of code from https://www.adeept.com/blog/tutorials/control-servo-to-rotate-180-degrees.html/1000, Lines 10, 11, 13 to 20 and 24 were copied directly from this tutorial (all the lines with comments), line 52 is also the same 
